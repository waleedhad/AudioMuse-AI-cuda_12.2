...
creative_prompt_template = (
    ...
    "CRITICAL: The most important features for naming are the genres: '{feature1}', '{feature2}', '{feature3}'. The playlist name MUST incorporate THE ONE more representive of these genres. Analyze the provided song list for its core vibe.\n"
