...
# Keep all your original functions here, but move them into app.py
# or import them if you prefer to keep them in a separate utility file.
# For simplicity, I'm placing them directly here for now, but in a larger
# project, you might put them in `utils.py` and import `from utils import *`.
